...
function ale_enqueue_styles() {
    ...
    wp_register_style( 'mainMin', THEME_URL . '/css/main.min.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_enqueue_style('aletheme_general_css');
    wp_enqueue_style('mainMin');
...
function ale_enqueue_scripts() {
	...
	wp_register_script( 'jquer', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'jquerymmenu', THEME_URL . '/js/libs/jquery.mmenu.all.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'fotorama', THEME_URL . '/js/libs/fotorama.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'magnific', THEME_URL . '/js/libs/jquery.magnific-popup.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'owl', THEME_URL . '/js/libs/owl.carousel.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'waypoints', THEME_URL . '/js/libs/waypoints.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'equal', THEME_URL . '/js/libs/jquery.equalheights.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'animate', THEME_URL . '/js/libs/animate-css.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'comm', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    //wp_register_script( 'scriptsmin', THEME_URL . '/js/scripts.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    
	
    wp_enqueue_script( 'jquer' );
    wp_enqueue_script( 'jquerymmenu' );
    wp_enqueue_script( 'fotorama' );
    wp_enqueue_script( 'magnific' );
    wp_enqueue_script( 'owl' );
    wp_enqueue_script( 'waypoints' );
    wp_enqueue_script( 'equal' );
    wp_enqueue_script( 'animate' );
    wp_enqueue_script( 'comm' );
    //wp_enqueue_script( 'scriptsmin' );
